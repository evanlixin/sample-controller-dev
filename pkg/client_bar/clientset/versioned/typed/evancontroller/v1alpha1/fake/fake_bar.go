...
type FakeBars struct {
	Fake *FakeEvancontrollerV1alpha1
	ns   string
}

var barsResource = schema.GroupVersionResource{Group: "evancontroller.k8s.io", Version: "v1alpha1", Resource: "bars"}

var barsKind = schema.GroupVersionKind{Group: "evancontroller.k8s.io", Version: "v1alpha1", Kind: "Bar"}

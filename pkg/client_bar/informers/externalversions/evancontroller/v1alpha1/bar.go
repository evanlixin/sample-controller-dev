...
import (
	"context"
	evancontrollerv1alpha1 "evanlixin/sample-controller-dev/pkg/apis/evancontroller/v1alpha1"
	versioned "evanlixin/sample-controller-dev/pkg/client_bar/clientset/versioned"
	internalinterfaces "evanlixin/sample-controller-dev/pkg/client_bar/informers/externalversions/internalinterfaces"
	v1alpha1 "evanlixin/sample-controller-dev/pkg/client_bar/listers/evancontroller/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EvancontrollerV1alpha1().Bars(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EvancontrollerV1alpha1().Bars(namespace).Watch(context.TODO(), options)
			},
		},
		&evancontrollerv1alpha1.Bar{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *barInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&evancontrollerv1alpha1.Bar{}, f.defaultInformer)
}
